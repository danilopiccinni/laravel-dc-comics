...
class ComicController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //     'thumb' => 'required|max:50|min:2|active_url',
