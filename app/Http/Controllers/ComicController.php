...
class ComicController extends Controller
{
    ...
    private function validatorDataForm($request) {
        ...
        $validator = Validator::make($formData, [
            ...
            'thumb' => 'required|max:500|min:2|active_url|url',
            'price' => 'required|min:1|numeric|decimal:2',
            'series' => 'required|max:50|min:2',
            'sale_date' => 'required|max:50|min:2|date',
            'type' => 'required|max:50|min:2',
            ...
            'price.decimal' => 'il prezzo deve avere 2 cifre decimali (separare interi e decimali con un "."',
