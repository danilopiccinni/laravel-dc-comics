    ...
    <div class="container m-3 ">
        ...
        <form  action="{{route('comics.store')}}" method="POST">
            ...
            <div class="mb-2">
                ...
                <input class="col-4 @error('sale_date') animate__animated animate__shakeX @enderror" style= "@error('sale_date') border : 1px solid red @enderror " type="date" id="sale_date" name="sale_date" value="{{old('sale_date')}}">
                @error('sale_date')
                    <em style="color:red"> {{$message}} </em>
                @enderror
            </div>
